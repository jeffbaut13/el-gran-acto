...
export const Scroll = () => {
  ...
  return (
    <figure className="scroll fixed bottom-20 left-1/2 -translate-x-1/2 z-[100] w-14 h-14 inline-block">
      ...
      >
        <g id="uuid-e8e5ed4a-4aca-424e-ba7e-a896ac384d1d" data-name="Capa 1">
          <g className="mouse">
            <path
              d="M10.9,32.11c-2.91,0-5.65-1.13-7.71-3.19-2.06-2.06-3.19-4.79-3.19-7.71v-10.32c0-2.91,1.13-5.65,3.19-7.71C5.25,1.13,7.99,0,10.9,0s5.65,1.13,7.71,3.19c2.06,2.06,3.19,4.79,3.19,7.71v10.32c0,2.91-1.13,5.65-3.19,7.71-2.06,2.06-4.79,3.19-7.71,3.19ZM10.9,1.55C5.74,1.55,1.55,5.74,1.55,10.9v10.32c0,5.15,4.19,9.35,9.35,9.35h0c5.15,0,9.35-4.19,9.35-9.35v-10.32c0-5.15-4.19-9.35-9.35-9.35Z"
