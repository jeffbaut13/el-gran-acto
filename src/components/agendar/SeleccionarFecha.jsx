            ...
            <form className="px-5 w-full flex flex-col justify-center h-full">
              ...
              <fieldset className="flex flex-col items-center md:py-5 xs:py-2">
                ...
                <select
                  ...
                  onChange={manejarCambioFormulario}
                  className="bg-transparent border border-primary rounded-lg w-full flexCenter placeholder:text-primary placeholder:opacity-35"
                >
                  <option className="w-full text-center inline-block" value="0">0</option>
                  <option className="w-full text-center inline-block" value="1">1</option>
                  <option className="w-full text-center inline-block" value="2">2</option>
                  <option className="w-full text-center inline-block" value="3">3</option>
                </select>
              </fieldset>
            </form>
          </div>
